...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "codereviewui/test/integration/FirstJourney",
    "codereviewui/test/integration/CodeReviewListJourney",
    "codereviewui/test/integration/CodeReviewObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
